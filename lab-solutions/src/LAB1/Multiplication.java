...
public class Multiplication{
        ...
        public static void multiplicationTableFor(int num) {
            System.out.println("LAB1.Multiplication table using for loop:");
            for (int i = 1; i <= 10; i++) {
        ...
        public static void multiplicationTableWhile(int num) {
            System.out.println("LAB1.Multiplication table using while loop:");
            int i = 1;
            while (i <= 10) {
                System.out.println(num + " x " + i + " = " + (num * i));
                i++;
        ...
        public static void multiplicationTableDoWhile(int num) {
            System.out.println("LAB1.Multiplication table using do-while loop:");
            int i = 1;
            do {
                System.out.println(num + " x " + i + " = " + (num * i));
                i++;
