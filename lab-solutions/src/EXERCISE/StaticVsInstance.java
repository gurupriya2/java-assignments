...
public class StaticVsInstance {
    public static void main(String[] args) {
        System.out.println("EXERCISE.StaticVsInstance");
        FamilyMember.toothPaste = "Colgate";
        FamilyMember.displayFamilyMemberDetails();
        System.out.println(FamilyMember.toothPaste);
//        System.out.println(EXERCISE.FamilyMember.toothBrush);
//        EXERCISE.FamilyMember.displayIndividualFamilyMemberDetails();
